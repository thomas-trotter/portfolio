...
# Real DETR output from /v1/inference/detect/visualize — reused for the project card
# Add `thumbnail: ./assets/thumbnail.png` only if you want a different card crop
hero: ./assets/hero-detection.png
---
...
![Interactive OpenAPI documentation at /docs, showing the image, editing, and inference route groups](./assets/swagger-docs.png)
